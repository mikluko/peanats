...
var (
	_ peanats.PutBucketEntry[testModel]    = (*testPutUpdateEntryImpl)(nil)
	_ peanats.UpdateBucketEntry[testModel] = (*testPutUpdateEntryImpl)(nil)
)

func TestBucket_New(t *testing.T) {
	t.Run("ok", func(t *testing.T) {
		nb := newKeyValueMock(t)
		b := peanats.NewBucket[testModel](nb)
		require.NotNil(t, b)
	})
}
...
func TestBucket_Get(t *testing.T) {
	...
	t.Run("with prefix", func(t *testing.T) {
		...
		b := peanats.NewBucket[testModel](nb, peanats.BucketKeyPrefix(prefix))
		v, err := b.Get(t.Context(), key)
		require.NoError(t, err)
		require.NotNil(t, v)
		assert.Equal(t, key, v.Key())
...
func TestBucket_Delete(t *testing.T) {
	...
	state := peanats.NewBucket[testModel](nb)
