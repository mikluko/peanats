...
// Bucket provides a mock function for the type Entry
func (_mock *Entry[T]) Bucket() string {
	ret := _mock.Called()
...
func (_c *Entry_Bucket_Call[T]) Return(s string) *Entry_Bucket_Call[T] {
	_c.Call.Return(s)
	return _c
}
...
// Created provides a mock function for the type Entry
func (_mock *Entry[T]) Created() time.Time {
	ret := _mock.Called()
...
func (_c *Entry_Created_Call[T]) Return(time1 time.Time) *Entry_Created_Call[T] {
...
// Delta provides a mock function for the type Entry
func (_mock *Entry[T]) Delta() uint64 {
	ret := _mock.Called()
...
func (_c *Entry_Delta_Call[T]) Return(v uint64) *Entry_Delta_Call[T] {
	_c.Call.Return(v)
	return _c
}
...
// Header provides a mock function for the type Entry
func (_mock *Entry[T]) Header() peanats.Header {
	ret := _mock.Called()
...
func (_c *Entry_Header_Call[T]) Return(v peanats.Header) *Entry_Header_Call[T] {
	_c.Call.Return(v)
	return _c
}
...
// Key provides a mock function for the type Entry
func (_mock *Entry[T]) Key() string {
	ret := _mock.Called()
...
func (_c *Entry_Key_Call[T]) Return(s string) *Entry_Key_Call[T] {
	_c.Call.Return(s)
	return _c
}
...
// Operation provides a mock function for the type Entry
func (_mock *Entry[T]) Operation() jetstream.KeyValueOp {
	ret := _mock.Called()
...
func (_c *Entry_Operation_Call[T]) Return(keyValueOp jetstream.KeyValueOp) *Entry_Operation_Call[T] {
...
// Revision provides a mock function for the type Entry
func (_mock *Entry[T]) Revision() uint64 {
	ret := _mock.Called()
...
func (_c *Entry_Revision_Call[T]) Return(v uint64) *Entry_Revision_Call[T] {
	_c.Call.Return(v)
	return _c
}
...
// Value provides a mock function for the type Entry
func (_mock *Entry[T]) Value() *T {
	ret := _mock.Called()
...
func (_c *Entry_Value_Call[T]) Return(v *T) *Entry_Value_Call[T] {
	_c.Call.Return(v)
	return _c
}
