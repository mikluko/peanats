...
func (_m *BucketEntry[T]) Header() xmsg.Header {
	ret := _m.Called()
	...
	var r0 xmsg.Header
	if rf, ok := ret.Get(0).(func() xmsg.Header); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(xmsg.Header)
		}
	}
...
func (_c *BucketEntry_Header_Call[T]) Return(_a0 xmsg.Header) *BucketEntry_Header_Call[T] {
	_c.Call.Return(_a0)
	return _c
}

func (_c *BucketEntry_Header_Call[T]) RunAndReturn(run func() xmsg.Header) *BucketEntry_Header_Call[T] {
	_c.Call.Return(run)
	return _c
}
