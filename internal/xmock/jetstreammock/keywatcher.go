...
func (_c *KeyWatcher_Stop_Call) Return(_a0 error) *KeyWatcher_Stop_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *KeyWatcher) Updates() <-chan jetstream.KeyValueEntry {
	ret := _m.Called()
...
func (_c *KeyWatcher_Updates_Call) Return(_a0 <-chan jetstream.KeyValueEntry) *KeyWatcher_Updates_Call {
	_c.Call.Return(_a0)
	return _c
}
