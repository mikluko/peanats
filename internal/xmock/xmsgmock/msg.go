...
func (_m *Msg) Header() xmsg.Header {
	ret := _m.Called()
...
func (_c *Msg_Header_Call) Return(_a0 xmsg.Header) *Msg_Header_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Msg_Header_Call) RunAndReturn(run func() xmsg.Header) *Msg_Header_Call {
	_c.Call.Return(run)
	return _c
}
