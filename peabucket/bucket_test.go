...
func (t *testPutUpdateEntryImpl) Header() xmsg.Header {
	return t.hdr
}
...
var (
	_ peabucket.PutBucketEntry[testModel]    = (*testPutUpdateEntryImpl)(nil)
	_ peabucket.UpdateBucketEntry[testModel] = (*testPutUpdateEntryImpl)(nil)
)

func TestBucket_New(t *testing.T) {
	t.Run("ok", func(t *testing.T) {
		nb := jetstreammock.NewKeyValue(t)
		b := peabucket.NewBucket[testModel](nb)
		require.NotNil(t, b)
	})
}
...
func TestBucket_Get(t *testing.T) {
	...
	t.Run("with prefix", func(t *testing.T) {
		...
		b := peabucket.NewBucket[testModel](nb, peabucket.BucketKeyPrefix(prefix))
		v, err := b.Get(t.Context(), key)
		require.NoError(t, err)
		require.NotNil(t, v)
		assert.Equal(t, key, v.Key())
...
func TestBucket_Put(t *testing.T) {
	...
	e := testPutUpdateEntryImpl{
		key: "parson.had.a.dog",
		hdr: xmsg.Header{"X-Breed": []string{"shavka"}},
...
func TestBucket_Delete(t *testing.T) {
	...
	state := peabucket.NewBucket[testModel](nb)
